...
def get_replay_buffer(policy, env, use_prioritized_rb=False, use_nstep_rb=False, n_step=1, size=None,
                      timesteps=0, bptt_hidden=0, make_predictions=10, pred_dim=5, use_map=False, 
                      neighbors=5, path_length=50, multi_selection=False,represent=False):
