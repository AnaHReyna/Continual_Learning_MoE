...
python stage2/train_student_moe_stage2.py \
  ...
  --init-ckpt results/stage2/phase1/Proto_AW/ckpt-14 \
  --phase 2 \
  --student-logdir results/stage2/phase2 \
  --student-name Proto-AW_ckpt14 \
  --student-epochs 150 \
  ...
  --old-task-new-expert-penalty-weight 0.0 \
  --new-task-old-expert-penalty-weight 0.0 \
