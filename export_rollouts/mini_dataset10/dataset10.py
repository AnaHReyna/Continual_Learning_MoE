...
#     build_success_replay_subset(src_dir="../export_rollouts/datasets/lane_keeping",
#                                 dst_dir="../export_rollouts/datasets/lane_keeping_replay_10pct_success",
#                                 fraction=0.10,
#                                 seed=42,
#                                 require_success=True                
#                                 )
...
# #   --replay-dirs ../export_rollouts/datasets/lane_keeping_replay_10pct_success \
# #   --init-ckpt checkpoints/stage1_lane_mean/ckpt-15 \
# #   --student-logdir checkpoints \
# #   --student-name stage2_ped_replay_10pct_success \
# #   --student-epochs 150 \
